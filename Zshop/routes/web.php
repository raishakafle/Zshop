...
Route::middleware(['auth','checksuperadmin'])->group(function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::get('manage-category',App\Http\Livewire\Admin\Category::class)->name('admin.category'); //Fixed an error in typo (admin -> Admin)
        ...
        Route::get('manage-FAQ',App\Http\Livewire\Admin\Faq::class)->name('admin.faq'); //Fixed an error in typo (.. -> Faq)
        Route::get('manage-customers',App\Http\Livewire\Admin\Users::class)->name('admin.users'); //Fixed an error in typo (users -> Users)
